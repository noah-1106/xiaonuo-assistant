...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="MacOS" key="h2h2DxbKDA"><RenderMd content={`\`\`\`Bash
export ARK_API_KEY="your_api_key_here"
\`\`\`

`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Linux" key="AYAa3sCkif"><RenderMd content={`\`\`\`Bash
export ARK_API_KEY="your_api_key_here"
\`\`\`

`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Windows_CMD" key="lo3eXFqeoS"><RenderMd content={`\`\`\`Bash
setx ARK_API_KEY "your_api_key_here"
\`\`\`

`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Windows_PowerShell" key="claGXFbqjE"><RenderMd content={`\`\`\`PowerShell
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="zvnCOdV4UK"><RenderMd content={`> 运行环境中需安装 [Python](https://www.python.org/downloads/) 版本 3.7 或以上。
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="T9jZw1snQh"><RenderMd content={`> 环境中安装 [Go](https://golang.google.cn/doc/install) 版本 1.18 或以上。
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="n869ZpLdN8"><RenderMd content={`> 环境中安装 [Java](https://www.java.com/en/download/help/index_installing.html) 版本 1.8 或以上。
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="rOHdN5UzNE"><RenderMd content={`\`\`\`Python
import os
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Curl" key="CafJ5hutTZ"><RenderMd content={`\`\`\`Bash
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="SJl2V2jrDP"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="bVprjMLCCW"><RenderMd content={`\`\`\`Java
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI SDK" key="wh463ePrIK"><RenderMd content={`\`\`\`Python
import os
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="wk9j9hLxr7"><RenderMd content={`\`\`\`Python
import os
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Curl" key="Dcl2RNqnaB"><RenderMd content={`\`\`\`Bash
curl https://ark.cn-beijing.volces.com/api/v3/responses \\
-H "Authorization: Bearer $ARK_API_KEY" \\
-H 'Content-Type: application/json' \\
-d '{
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="WC8eZ3couz"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="dlk9TGyYKT"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI SDK" key="c7al2G7uTw"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="o1hCu4yzEI"><RenderMd content={`\`\`\`Python
import os
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Curl" key="a5nPu0ExB3"><RenderMd content={`\`\`\`Bash
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="svrurrQYbU"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="sbbzGanjEC"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI" key="IK6jXk6eTz"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="fWG9L6552v"><RenderMd content={`\`\`\`Python
import os
import time  
# Install SDK:  pip install 'volcengine-python-sdk[ark]'
from volcenginesdkarkruntime import Ark 
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="Pm8lNMTU4N"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="oMsFdqxcgX"><RenderMd content={`\`\`\`Go
package main
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="X3LR7ZiyrH"><RenderMd content={`\`\`\`Python
import os
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Curl" key="Xqhe5ajuJY"><RenderMd content={`\`\`\`Bash
curl https://ark.cn-beijing.volces.com/api/v3/responses \\
-H "Authorization: Bearer $ARK_API_KEY" \\
-H 'Content-Type: application/json' \\
-d '{
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="n8bvbSiXOg"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="DNfptPAkWp"><RenderMd content={`\`\`\`Go
package main
import (
  "context"
  "fmt"
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI SDK" key="pj8ELqNDYo"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
